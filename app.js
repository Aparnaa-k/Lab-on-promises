...
function getData() {
  ...
  fetch('https://jsonplaceholder.typicode.com/users')
    .then((res) => res.json()) // Corrected the parentheses

    .then((result) => { // Added parentheses
      ...
      console.log(arr); // Changed from getBody to arr
    })
...
getBtn.addEventListener('click', getData); // Corrected the event listener
